...
\newcommand{\BoxStart}{%
    ...
    \begin{tiny}
}\def\BoxEnd{\end{tiny}\end{tcolorbox}}
...
\begin{multicols*}{3}
  ...
  \input{basics.tex}
  \input{zufallsvariable.tex}
  \input{diskrete-verteilung.tex}
  \input{verteilung.tex}
  \input{ungleichungen.tex}
  \input{schätzer.tex}
  \input{tests.tex}
  \input{multiple-choice.tex}
  \input{verteilungen-tabelle.tex}
  \input{sonstiges.tex}
