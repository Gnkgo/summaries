...
\greenbf{Apature problem:} 1 equation, 2 unknowns cannot determine exact location, take normal flow. TODO\\
...
\greenbf{Affine motion:} $I_x(a_1 + a_2x + a_3y) + I_y(a_4 + a_5x + a_6y) + I_t \approx 0$ TODO\\
