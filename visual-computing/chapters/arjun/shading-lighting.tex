...
\includegraphics*[width = \columnwidth]{jo/phong.png}
...
\greenbf{Ambient:} Light that shines independent of viewpoint \& angle. (Imagine it is object glowing) \\
...
\end{compactenum}
\begin{center}
    \includegraphics*[width = 0.5\columnwidth]{jo/phong-shading.png}
\end{center}
