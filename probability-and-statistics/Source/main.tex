...
\usepackage[landscape, left=0.20cm, top=0.2cm, right=0.20cm, bottom=0.6cm, footskip=15pt]{geometry}
...
\titleformat*{\section}{\fontsize{11}{11}\bfseries\color{blue}}
\titleformat*{\subsection}{\fontsize{11}{11}\bfseries\color{purple}}
% define box
\begin{document}
\setlength{\columnseprule}{0.4pt}
